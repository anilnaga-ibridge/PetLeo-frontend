...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'superadmin-dynamic-providerfields-dynamicform': RouteRecordInfo<'superadmin-dynamic-providerfields-dynamicform', '/superadmin/dynamic-providerfields/dynamicform', Record<never, never>, Record<never, never>>,
    'superadmin-dynamic-providerfields-profile-form': RouteRecordInfo<'superadmin-dynamic-providerfields-profile-form', '/superadmin/dynamic-providerfields/profile-form', Record<never, never>, Record<never, never>>,
    'superadmin-dynamic-providerfields-provider-profile': RouteRecordInfo<'superadmin-dynamic-providerfields-provider-profile', '/superadmin/dynamic-providerfields/provider-profile', Record<never, never>, Record<never, never>>,
