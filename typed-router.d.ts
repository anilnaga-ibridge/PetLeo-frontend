...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'superadmin-pet-types': RouteRecordInfo<'superadmin-pet-types', '/superadmin/pet_types', Record<never, never>, Record<never, never>>,
    'superadmin-plans': RouteRecordInfo<'superadmin-plans', '/superadmin/plans', Record<never, never>, Record<never, never>>,
