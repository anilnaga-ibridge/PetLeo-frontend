...
<template>
  <VCard
    flat
    border
    class="consultation-settings pa-8 rounded-[32px]"
  >
    <div class="d-flex align-center justify-space-between mb-8">
      <div>
        ...
        <p class="text-body-1 text-slate-500 ml-12">
          Define different types of visits and their respective fees.
        </p>
      </div>
      <VBtn
        color="primary"
    ...
    <VRow v-else-if="types.length > 0">
      ...
      >
        <VCard
          border
          flat
          class="rounded-2xl h-100 d-flex flex-column"
        >
          <VCardItem>
            <template #prepend>
              <VAvatar
    ...
    >
      ...
      <p class="text-slate-400">
        Start by adding your first consultation type to enable bookings.
      </p>
    </div>
      ...
      <VCard class="rounded-2xl">
        <VCardTitle class="pa-6 pb-0">
          <h2 class="text-h5 font-weight-black">
            {{ form.id ? 'Edit' : 'Add' }} Consultation Type
          </h2>
        </VCardTitle>
