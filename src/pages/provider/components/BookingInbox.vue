...
<template>
  <div class="booking-inbox">
    <div class="d-flex align-center justify-space-between mb-8">
      <div>
        <h2 class="text-h3 font-weight-black text-slate-800 tracking-tighter">
          Booking Requests
        </h2>
        <p class="text-subtitle-1 text-slate-500 font-weight-medium">
          Manage your incoming service requests and active schedule.
        </p>
      </div>
      <VBtn 
        icon="tabler-refresh" 
    ...
    <div
      ...
      class="text-center py-16 bg-slate-50 rounded-[32px] border-2 border-dashed"
    >
      <VIcon
        ...
        >
          <div class="d-flex align-center justify-space-between flex-wrap gap-6">
            ...
            <div class="d-flex align-center gap-6">
              ...
              <div>
                <div class="d-flex align-center gap-2 mb-1">
                  <h4 class="text-h4 font-weight-black text-slate-900">
            ...
            <div class="d-flex align-center gap-8 flex-grow-1 px-8 border-s border-e mx-4 border-slate-100">
              <div>
                <div class="label-tiny uppercase mb-1">
                  Schedule
                </div>
