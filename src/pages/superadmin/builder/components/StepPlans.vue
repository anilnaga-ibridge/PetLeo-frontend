              ...
              >
                ...
                <VExpandTransition>
                  ...
                  >
                    ...
                    <!-- HIERARCHY DISPLAY -->
                    <div
                      v-if="svc.categories && svc.categories.length > 0"
                      class="mt-4 pt-4 border-t"
                    >
                      <div class="text-caption font-weight-bold text-uppercase text-medium-emphasis mb-2">
                      ...
                      <div class="ml-1">
                        ...
                        >
                          ...
                          <div
                            v-if="cat.facilities && cat.facilities.length > 0"
                            class="ml-6 d-flex flex-wrap gap-2"
                          >
                            <VChip 
                          ...
                          <div
                            v-else
                            class="ml-6 text-caption text-disabled font-italic"
                          >
