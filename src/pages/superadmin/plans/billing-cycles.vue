  ...
  <section>
    <VCard class="mb-6">
      <VCardItem class="pb-2">
        <VCardTitle class="text-h5 font-weight-bold">Billing Cycles Management</VCardTitle>
      </VCardItem>
      ...
      <VCardText>
        <VRow>
          ...
          <VCol cols="12" sm="8" class="d-flex justify-end">
            <VBtn color="primary" prepend-icon="tabler-plus" @click="openAddDrawer">
              Add Billing Cycle
            </VBtn>
          </VCol>
        </VRow>
      ...
      >
        <template #item.code="{ item }">
          <VChip color="primary" label>{{ item.code }}</VChip>
        </template>
    ...
    >
      <div class="d-flex justify-space-between align-center mb-4">
        ...
        <IconBtn @click="drawerOpen = false"><VIcon icon="tabler-x" /></IconBtn>
      </div>

      <VForm @submit.prevent="submit">
        <VRow>
          <VCol cols="12">
            <AppTextField v-model="form.code" label="Code (e.g. MONTHLY) *" />
          </VCol>

          <VCol cols="12">
            <AppTextField v-model="form.display_name" label="Display Name (e.g. Monthly) *" />
          </VCol>
          ...
          <VCol cols="12" class="d-flex justify-end gap-2">
            <VBtn variant="text" @click="drawerOpen = false">Cancel</VBtn>
    ...
    <VDialog v-model="deleteDialog" width="400">
      <VCard title="Delete Billing Cycle?">
        ...
        <VCardActions class="justify-end">
          ...
          <VBtn color="error" @click="deleteBillingCycle">Delete</VBtn>
        </VCardActions>
      </VCard>
    </VDialog>
  </section>
