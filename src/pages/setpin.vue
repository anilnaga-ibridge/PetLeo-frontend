...
<template>
  <VRow class="auth-wrapper justify-center align-center" style="height:100vh;">
    <VCol cols="12" md="4">
      <VCard class="pa-6" style="border-radius:18px">

        <h3 class="text-center">Set Your PIN</h3>
        ...
        <VAlert type="success" class="mt-3" v-if="successMessage">{{ successMessage }}</VAlert>
        <VAlert type="error" class="mt-3" v-if="errorMessage">{{ errorMessage }}</VAlert>
