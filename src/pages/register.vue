...
<template>
  ...
  <VRow no-gutters class="auth-wrapper bg-surface">
    ...
    <VCol md="8" class="d-none d-md-flex">
      <div class="position-relative bg-background w-100 me-0">
        <div class="d-flex align-center justify-center w-100 h-180" style="padding-inline: 100px;">
          <VImg :src="imageVariant" max-width="500" class="auth-illustration mt-16 mb-2" />
        </div>
    ...
    <VCol cols="12" md="4" class="auth-card-v2 d-flex align-center justify-center">
      <VCard flat :max-width="500" class="pa-4 mt-12 mt-sm-0">
        ...
        <VCardText>
          <VForm @submit.prevent="registerUser">
            <VRow>
              ...
              <VCol cols="12">
                <label class="text-body-1 font-weight-medium mb-2 d-block">Select Role</label>
                ...
                <div class="d-flex gap-4">
                  ...
                  <VCard
                    ...
                    :elevation="form.role === r.value ? 6 : 1"
              ...
              <VCol cols="12">
                <div class="d-flex align-center my-6">
                  ...
                  <VLabel for="privacy-policy" style="opacity: 1;">
                    ...
                    <a class="text-primary" href="#">privacy policy & terms</a>
                  </VLabel>
                </div>
              </VCol>
...
.custom-input .v-icon { color: #4f46e5 !important; }
.custom-input .v-input__control { border-radius: 12px !important; }
