      ...
      <div class="d-flex align-center justify-space-between mb-6">
        <div class="d-flex align-center">
          <VBtn
            ...
            variant="text"
            to="/veterinary/doctor-dashboard"
            class="me-2"
          />
          <div>
            ...
            <div class="text-body-1 text-medium-emphasis">
              {{ visit.pet.species }} • {{ visit.pet.age }} • {{ visit.owner.name }}
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <VCardText v-if="visit.forms.VITALS">
              <div
                v-for="(vital, k) in visit.forms.VITALS[0].data"
                :key="k"
        ...
        <VCard>
          ...
          <VCardText>
            <DynamicFormRenderer
              ...
              @cancel="showPrescriptionDialog = false"
            />
          </VCardText>
        </VCard>
      </VDialog>
