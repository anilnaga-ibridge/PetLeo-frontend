...
<template>
  <VCard class="booking-card-premium pa-4 mb-4" elevation="0" border>
    <div class="d-flex align-center">
      <div class="provider-avatar-container me-4">
        <VAvatar size="56" color="primary-lighten-5">
          <VIcon icon="tabler-calendar-heart" color="primary" size="32" />
        </VAvatar>
      </div>
      ...
      <div class="flex-grow-1">
          ...
          <div>
            ...
            <div class="mb-2">
              <div class="d-flex justify-space-between align-center">
                ...
                <div v-if="booking.service_snapshot?.price" class="text-subtitle-2 font-weight-black text-primary">
            ...
            <div class="d-flex align-center gap-2">
              <VIcon icon="tabler-paw" size="14" color="slate-400" />
        ...
        <div class="d-flex align-center justify-space-between mt-3">
          <div class="d-flex align-center text-body-2 text-slate-700">
            <VIcon icon="tabler-clock" size="16" class="me-1" color="slate-400" />
            {{ formattedDate }}
          </div>
          
          <div v-if="booking.status === 'CONFIRMED' && booking.completion_otp" class="d-flex align-center gap-2 bg-primary-lighten-5 px-3 py-1 rounded-pill">
            <VIcon icon="tabler-lock-password" size="16" color="primary" />
