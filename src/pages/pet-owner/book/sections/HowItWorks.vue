      ...
      <div class="cta-strip-inner">
        ...
        <div class="cta-actions">
          <VBtn
            color="white"
            height="50"
            class="px-8 font-weight-black rounded-2xl cta-primary-btn"
...
.step-item {
  ...
  padding: 0 20px;
  position: relative;
  animation: fadeStepUp 0.6s cubic-bezier(0.2,0,0,1) both;
}
...
.cta-paw { font-size: 48px; flex-shrink: 0; }
